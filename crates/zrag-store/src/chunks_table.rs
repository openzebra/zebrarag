...
use zrag_common::chunk_strategy::ChunkStrategy;
use zrag_common::file_type::FileType;
...
impl ChunksTable {
    ...
    pub async fn build_index(&mut self, params: &zrag_ann::SearchParams) -> Result<()> {
        ...
        let index = match params.method {
            zrag_ann::SearchMethod::IvfHnswSq => Index::IvfHnswSq(
            ...
            zrag_ann::SearchMethod::IvfHnswPq => Index::IvfHnswPq(
            ...
            zrag_ann::SearchMethod::IvfPq => Index::IvfPq(
                IvfPqIndexBuilder::default()
                    .distance_type(dist)
                    .num_partitions(np)
                    .num_sub_vectors(nsv),
            ),
            zrag_ann::SearchMethod::IvfSq => Index::IvfSq(
                IvfSqIndexBuilder::default()
                    .distance_type(dist)
                    .num_partitions(np),
            ),
            zrag_ann::SearchMethod::IvfRq => Index::IvfRq(
                IvfRqIndexBuilder::default()
                    .distance_type(dist)
                    .num_partitions(np),
            ),
            zrag_ann::SearchMethod::Flat
            | zrag_ann::SearchMethod::Usearch
            | zrag_ann::SearchMethod::TurboQuant => {
                self.index_created = true;
                return Ok(());
            }
        };
    ...
    pub async fn knn(
        ...
        if params.method.is_lancedb_index() {
            ...
            if matches!(
                params.method,
                zrag_ann::SearchMethod::IvfHnswSq | zrag_ann::SearchMethod::IvfHnswPq
            ) {

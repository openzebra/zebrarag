...
use zrag_ts_core::types::{EdgeKind, Kind, Target};
...
mod tests {
    ...
    fn mk_index(symbols: Vec<zrag_ts_core::types::Symbol>, files: Vec<FileEntry>) -> ProjectIndex {
        ProjectIndex {
            symbols,
            edges: Vec::new(),
            files,
    ...
    fn mk_sym(id: u32, name: &str, kind: Kind, file_idx: u16) -> zrag_ts_core::types::Symbol {
        zrag_ts_core::types::Symbol {
            id,
            kind,
            name: name.to_string(),

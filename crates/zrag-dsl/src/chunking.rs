...
pub use zrag_common::chunk_strategy::ChunkStrategy;
...
pub struct DslChunker<'a> {
    ...
    symbols_by_file: FxHashMap<u16, Vec<&'a zrag_ts_core::types::Symbol>>,
}

impl<'a> DslChunker<'a> {
    pub fn new(index: &'a ProjectIndex) -> Self {
        let mut symbols_by_file: FxHashMap<u16, Vec<&'a zrag_ts_core::types::Symbol>> =
